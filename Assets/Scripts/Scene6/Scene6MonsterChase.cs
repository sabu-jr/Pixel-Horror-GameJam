...
public class Scene6MonsterChase : MonoBehaviour
{
    public Transform player;          // Reference to the player's transform
    public float followDistance = 0f; // The distance the NPC will keep from the player
    public float moveSpeed = 2f;      // The speed at which the NPC moves towards the player
